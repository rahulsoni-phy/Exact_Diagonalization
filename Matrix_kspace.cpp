...
//B_mag
C_mat[0][0].real(-B_mag);C_mat[0][0].imag(0.0);
C_mat[1][1].real(B_mag);C_mat[1][1].imag(0.0);
C_mat[2][2].real(-B_mag);C_mat[2][2].imag(0.0);
C_mat[3][3].real(B_mag);C_mat[3][3].imag(0.0);
